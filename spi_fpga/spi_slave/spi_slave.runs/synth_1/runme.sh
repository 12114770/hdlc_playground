...
HD_PWD='/home/lukas/OneDrive/raspberry/hdlc_playground/spi_fpga/spi_slave/spi_slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_spi_slave_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_spi_slave_led.tcl
