...
HD_PWD='/home/lukas/OneDrive/raspberry/hdlc_playground/spi_fpga/spi_slave/spi_slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_spi_slave_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_spi_slave_led.tcl -notrace
